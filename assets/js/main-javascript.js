$(document).ready(function() {
    ...
    $('#clickcopper').click(function() {
      $('#copper1, #copper2').toggle();
      $('#silver1, #silver2, #gold1, #gold2, #diamond1, #diamond2').hide();
    });

    // Bắt sự kiện click cho nút
    $('#clicksilver').click(function() {
      $('#silver1, #silver2').toggle();
      $('#copper1, #copper2, #gold1, #gold2, #diamond1, #diamond2').hide();
    });

    // Bắt sự kiện click cho nút
    $('#clickgold').click(function() {
      $('#gold1, #gold2').toggle();
      $('#copper1, #copper2, #silver1, #silver2, #diamond1, #diamond2').hide();
    });

    // Bắt sự kiện click cho nút
    $('#clickdiamond').click(function() {
      $('#diamond1, #diamond2').toggle();
      $('#copper1, #copper2, #silver1, #silver2, #gold1, #gold2').hide();
    });
  });
...
$(document).on('click', '#success', function (e) {
    swal(
        'Success',
        'Your information has been <b style="color:green;">updated</b>!',
        'success'
    )
});
